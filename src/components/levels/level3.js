...
const Level3 = () => {
   ...
   function addImagetoBox7(key){
    ...
    function checkimg(){
    let firstbox= document.getElementById('l3b1');
    let secondbox= document.getElementById('l3b2');
    let thirdbox= document.getElementById('l3b3');
    let fourbox= document.getElementById('l3b4');
    let fivebox= document.getElementById('l3b5');
    let sixbox= document.getElementById('l3b6');
    let sevenbox= document.getElementById('l3b7');
    ...
    //evaluation function
    function evaluation(){
    let first= document.getElementById('l3b1').querySelector("img").getAttribute("name");
    let second= document.getElementById('l3b2').querySelector("img").getAttribute("name");
    let third= document.getElementById('l3b3').querySelector("img").getAttribute("name");
    let four= document.getElementById('l3b4').querySelector("img").getAttribute("name");
    let five= document.getElementById('l3b5').querySelector("img").getAttribute("name");
    let six= document.getElementById('l3b6').querySelector("img").getAttribute("name");
    let seven= document.getElementById('l3b7').querySelector("img").getAttribute("name");
