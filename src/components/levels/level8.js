...
const Level8 = () => {
   ...
   function addImagetoBox6(key){
    ...
    function checkimg(){
    let firstbox= document.getElementById('l4b1');
    let secondbox= document.getElementById('l4b2');
    let thirdbox= document.getElementById('l4b3');
    let fourbox= document.getElementById('l8b4');
    let fivebox= document.getElementById('l8b5');
    let sixbox= document.getElementById('l8b6');
    ...
    if(firstno || secondno || thirdno || fourno || fiveno || sixno){
    ...
    //evaluation function
    function evaluation(){
    let first= document.getElementById('l4b1').querySelector("img").getAttribute("name");
    let second= document.getElementById('l4b2').querySelector("img").getAttribute("name");
    let third= document.getElementById('l4b3').querySelector("img").getAttribute("name");
    let four= document.getElementById('l8b4').querySelector("img").getAttribute("name");
    let five= document.getElementById('l8b5').querySelector("img").getAttribute("name");
    let six= document.getElementById('l8b6').querySelector("img").getAttribute("name");
